...
<h2><span id="ctl00_ContentPlaceHolder1_SearchHomeControl1_lblHeader">Вписвания, заличавания и обявявания</span></h2>
    ...
    <tbody>
		...
		<td>
            ...
            <!--<img src="img/CaptchaImage.jpg" width="180" height="50" border="0">-->
                <asp:Image ID="Image1" runat="server" Height="46px" ImageUrl="~/img/CaptchaImage.jpg" Width="100px"  />
            </span>
         </td>
		<td>
            <span style="margin:5px;float:left; color:#FF0004;">Въведете показания код:<br>
    ...
    <tbody>
    <tr>
		<td style="padding-right: 5px; width:50px!important;">
           <input id="Text2" type="text" width="50" />
		</td>

		<td style="padding-left: 5px; padding-right: 5px;  width:50px!important;">
           <input id="Text3" type="text"  width="50" /></td>
		<td style="padding-left: 5px;  width:100px!important;">
           <input id="Text4" type="text"  width="100"/></td>
		<td><asp:Image ID="Image2" runat="server" ImageUrl="~/img/datepicker.gif"/></td>
